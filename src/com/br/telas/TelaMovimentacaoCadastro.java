...
public class TelaMovimentacaoCadastro extends javax.swing.JDialog {
    ...
    private boolean inserir, despesa;
    ...
    private Movimentacao getcMovimentacao() {
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(txObservacao, javax.swing.GroupLayout.Alignment.TRAILING)
                            .addComponent(cbCategoria, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addGroup(layout.createSequentialGroup()
                                .addComponent(txValor, javax.swing.GroupLayout.PREFERRED_SIZE, 122, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (!verificarCampos()) {
            if (isInserir()) {
                new MovimentacaoDao().inserir(getcMovimentacao());
                Msg.informacao(this, "Salvo com sucesso!");
                this.pai.atualizarTabela();
                this.dispose();
            } else {
                new MovimentacaoDao().alterar(getcMovimentacao());
